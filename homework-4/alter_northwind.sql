...
DELETE FROM order_details WHERE EXISTS(SELECT discontinued FROM products WHERE discontinued = 1)
DELETE FROM products WHERE discontinued = 1
--Либо
ALTER TABLE products DROP CONSTRAINT fk_products_discontinued
DELETE FROM products WHERE discontinued = 1 -- Но не смог проверить, сработает ли