...
SELECT COUNT(supplier_id), country FROM suppliers GROUP BY country ORDER BY COUNT(supplier_id) DESC
...
INNER JOIN
customers ON employees.country = customers.country
INNER JOIN
suppliers ON employees.country = suppliers.country
